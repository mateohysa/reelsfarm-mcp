import type { JsonObject, MaybePrepared, MutationOptions, SlideshowType } from '../types.js';
...
export class SlideshowsDomain extends DomainBase {
  ...
  async generateText(params: { prompt: string; slideshowType?: SlideshowType; slideCount?: number; productContextId?: string } & MutationOptions): Promise<MaybePrepared<ReelsFarmJob | JsonObject>> {
